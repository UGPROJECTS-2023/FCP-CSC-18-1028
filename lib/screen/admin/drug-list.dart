                                    ...
                                    itemBuilder: (context, index) {
                                      return Padding(
                                        ...
                                        child: CustomerContainer(
                                          ...
                                          from: customerData[index]['reg_no'],
                                          to: customerData[index]['password'],
                                          reject: () {
                                            showReject(context, () {
                                          ...
                                          price:
                                              "${customerData[index]['email']}",
                                          percentage:
                                              "${customerData[index]['password']}",

                                          // percentageNo: "0.${customerData[index]['qty1'][]}",
                                          counter: index + 1,
                                          date:
                                              "${customerData[index]['password']}",
                                          ...
                                          title: customerData[index]['drugname']
                                              .toUpperCase(),
                                          qty: customerData[index]['password'],
                                          mfd: customerData[index]['password'],
